      ...
      >
        ...
        >
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2">Programming Skills</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2">Toolsl & others</h3>
            <ul className="text-secondary space-y-2">
              <li>MS Office</li>
            </ul>
          </motion.div>
      ...
      >
        ...
        >
          <motion.div 
            ...
            {...cardHoverSmall}
          >
            <h3 className="text-xl font-semibold mb-2">Bachelor of Science in Civil Engineering</h3>
            <p className="text-primary mb-2">University Name • time - time</p>
